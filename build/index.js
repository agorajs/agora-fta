...
exports.forceTransfer = function (graph, options) {
    if (options === void 0) { options = { padding: 0, seed: { x: 0, y: 0 } }; }
    var _loop_1 = function () {
        var d = options.padding;
        var seed = virtual_nodes_1.createSeed(options.seed);
...
function directedRemoveOverlap(nn, tnn, i, d, dir) {
    ...
    lodash_1.default.forEach(directedTNN, function (j) {
        ...
        var jTNN = dir.filter(transfer_neighbor_nodes_1.TNN(directedTNN, j, d), j);
