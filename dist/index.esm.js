...
import { top, right, bottom, left, norm, overlap, createFunction, hasOverlap } from 'agora-graph';
...
function createVirtualNode(i, v, s) {
  ...
  if (s === void 0) if (norm(borderNodes.top, topleft) > norm(borderNodes.left, topleft)) {
    s = borderNodes.left;
  } else {
    s = borderNodes.top;
  }
 ...
 */
var forceTransfer = createFunction(function (graph) {
...
export { ForceTransferAlgorithm, forceTransfer };
